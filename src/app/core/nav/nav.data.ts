...
export interface NavScreen { code: string; title: string; path: string;
  archetype: string; flagship: boolean; }
export interface NavSection { name: string; screens: NavScreen[]; }
export interface NavModule { module: string; label: string; path: string;
  owner: Role; roles: Role[]; sections: NavSection[]; }

/** Module → section → screen. Drives the rail; generated, never typed. */
